...
private fun vowels(str: String): Int {
    ...
    var map = str.groupingBy { it }.eachCount().filter {
                it.key.toLowerCase() ==  'a'
                || it.key.toLowerCase() == 'e'
                || it.key.toLowerCase() == 'i'
                || it.key.toLowerCase() == 'o'
                || it.key.toLowerCase() == 'u'
                || it.key.toLowerCase() == 'y'
    }
